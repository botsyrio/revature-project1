let listRoot = document.getElementById('allResolvedList');
fetch('/manager/allResolvedReqs')
    .then(res => res.json())
    .then(requestList => {
        for(const request of requestList){
            ...
            let managerResolvedField = document.createElement("div");
            managerResolvedField.textContent = request.managerResolver.firstName+" "+request.managerResolver.lastName;
            nextNode.appendChild(managerResolvedField);
